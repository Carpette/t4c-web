...
// Usage : node tools/dump-scene.js [sortie.json] [island|trial|arakas] [seed]
import fs from 'node:fs';
import { generateWorld, generateTrial } from '../shared/worldgen.js';
import { buildDecor } from '../client/js/render2d/decor.js';

const kind = process.argv[3] || 'arakas';
const seed = process.argv[4] ? parseInt(process.argv[4], 10) : undefined;
const world = kind === 'trial' ? generateTrial(seed || 8281932)
  : kind === 'arakas' ? generateWorld(0, 'arakas')
  : generateWorld(seed);
